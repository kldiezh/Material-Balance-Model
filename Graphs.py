...
fig.suptitle('Production Data Analysis', fontsize=16, fontweight='bold')
...
ax1.set_title('Cumulative oil production', fontsize=12)

ax2.plot(t, qo, color='purple', label='qo')
ax2.set_xlabel('Time (months)', fontsize=10, fontweight='bold')
ax2.set_ylabel('qo (STB/D)', fontsize=10, fontweight='bold')
ax2.grid(True, which='both', linestyle='--', linewidth=0.5)
ax2.set_title('Oil production rate', fontsize=12)
